...
import java.util.regex.Pattern;
    ...
    public enum Country
    {
        ...
        private static final Map<String, Country> alpha4Map = new HashMap<String, Country>();
         ...
         *         >ISO 3166-1 alpha-2</a> code.
         *         {@link Country#UNDEFINED} returns {@code "UNDEFINED"}
         ...
         *         returns {@code null}.
         *         {@link Country#UNDEFINED} returns {@code null}, too.
         */
         ...
         *         returns {@code -1}.
         *         {@link Country#UNDEFINED} returns {@code -1}, too.
         */
         ...
         * </tr>
         * <tr>
         *   <td>{@link Country#CA CountryCode.CA}</td>
         *   <td>{@link Locale#CANADA}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#CN CountryCode.CN}</td>
         *   <td>{@link Locale#CHINA}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#DE CountryCode.DE}</td>
         *   <td>{@link Locale#GERMANY}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#FR CountryCode.FR}</td>
         *   <td>{@link Locale#FRANCE}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#GB CountryCode.GB}</td>
         *   <td>{@link Locale#UK}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#IT CountryCode.IT}</td>
         *   <td>{@link Locale#ITALY}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#JP CountryCode.JP}</td>
         *   <td>{@link Locale#JAPAN}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#KR CountryCode.KR}</td>
         *   <td>{@link Locale#KOREA}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#TW CountryCode.TW}</td>
         *   <td>{@link Locale#TAIWAN}</td>
         * </tr>
         * <tr>
         *   <td>{@link Country#US CountryCode.US}</td>
         *   <td>{@link Locale#US}</td>
         * </tr>
         * </table>
         *
         * <p>
         * In addition, {@code toLocale()} of {@link Country#UNDEFINED
         ...
         */
        public static Country getByLocale(Locale locale)
        {
            if (locale == null)
            {
                return null;
         ...
         * @since 1.23
         */
        public static Country getByAlpha2Code(String code)
        {
            try
            {
         ...
         * @since 1.23
         */
        public static Country getByAlpha3Code(String code)
        {
         ...
         * @since 1.23
         */
        public static Country getByAlpha4Code(String code)
        {
         ...
         * @since 1.11
         */
        public static List<Country> findByName(String regex)
        {
            if (regex == null)
            {
         ...
         * @since 1.11
         */
        public static List<Country> findByName(Pattern pattern)
        {
            if (pattern == null)
            {
